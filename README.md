...
[2025-09-01] 抖音福袋扭蛋机，抖音抢福袋工具，抖音无水印视频下载器，抖音直播间录制下载器，抖音批量取消关注取关器。
...
<span style="color:red; font-weight:bold;">v3.2.0</span>


优化了福袋池扫描参数，VIP用户扫描的福袋池质量会更好(参与人数更少)，福袋数量更多(参与空间更大)。

解决了VIP显示的bug。部分VIP用户显示没有优化福袋池，是验证服务器拥挤的显示问题，实际不受影响。VIP福袋池一般同一时间在200个左右，免费福袋池一般在100以下，互相不冲突，很容易辨别。

解决了固定直播间抢福袋的bug，现在可以正常执行指令。
...
https://github.com/testusyd/douyin_downloader/releases/download/%E6%8A%96%E9%9F%B3/douyin_downloader_v3.2.0.zip
